...
<div class="container mx-auto p-6">
  <h1 class="text-2xl font-bold mb-6">🔍 Convex + Clerk Debug Console</h1>
  ...
  <div class="grid gap-6">
    ...
    <div class="bg-blue-100 p-4 rounded">
      <h2 class="font-semibold mb-2">🔐 Clerk Status</h2>
    ...
    <div class="bg-green-100 p-4 rounded">
      <h2 class="font-semibold mb-2">⚡ Convex Status</h2>
      <p>
    ...
    <div class="bg-yellow-100 p-4 rounded">
      ...
      <div class="max-h-64 overflow-y-auto">
        {#each debugInfo.errors as error, i}
          <p class="text-sm font-mono mb-1">[{i + 1}] {error}</p>
        {/each}
        {#if debugInfo.errors.length === 0}
          <p class="text-gray-500 text-sm">No debug messages yet...</p>
        {/if}
      </div>
