...
export const SAMPLE_DATA_CONFIG = {
  ...
  habits: [
    ...
    },
    {
      ...
      name: "🍁 Weed",
      description:
        "Engaging in smoking weed. Monitor and log each occurrence to identify patterns and triggers.",
      type: "negative" as const,
      timerEnabled: false,
      targetDurationMinutes: null,
      pointsValue: 15,
    ...
    },
    {
      ...
      name: "🪥 Hygiene",
      description:
        "Maintain daily hygiene practices like brushing teeth and washing face. These small actions help maintain public dignity and personal well-being.",
    ...
    },
    {
      ...
      name: "💻 Code",
      description:
        "Dedicate time to building projects, debugging, or exploring new tech stacks. Aim for focused deep work with a specific deliverable each session.",
      type: "positive" as const,
      timerEnabled: true,
    ...
    },
    {
      ...
      name: "🖌️ Design",
      description:
        "Engage in visual creativity, whether analog or digital. Aim for quick iterations and complete at least one thumbnail or study per session.",
      type: "positive" as const,
      timerEnabled: true,
      targetDurationMinutes: 45,
      pointsValue: 50,
    ...
    },
    {
      ...
      name: "♟️ Chess",
      description:
        "Play chess or solve puzzles to enhance strategic thinking. Review one mistake after each session for continuous improvement.",
      type: "positive" as const,
      timerEnabled: true,
      targetDurationMinutes: 15,
      pointsValue: 15,
    ...
    },
    {
      ...
      name: "🎓 Watch Lecture",
      description:
        "Watch and absorb educational content. Capture key notes and identify one actionable item to apply within 24 hours.",
      type: "positive" as const,
      timerEnabled: true,
    ...
    },
    {
      ...
      name: "➗ Study Math",
      description:
        "Work through math problems or theory. Alternate between solving problems and short derivations, logging errors and corrections as you go.",
      type: "positive" as const,
      timerEnabled: true,
      targetDurationMinutes: 45,
      pointsValue: 50,
    ...
    },
    {
      ...
      description:
        "Read books on real-world topics and summarize one actionable takeaway from each session.",
      type: "positive" as const,
      timerEnabled: true,
